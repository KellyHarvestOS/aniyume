...
export default function HeaderLanguageToggle({ className = '' }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`group flex h-9 items-center justify-center rounded-lg px-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-200 ${className}`}
    >
