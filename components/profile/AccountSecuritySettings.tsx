    ...
    <section className="md:col-span-2 space-y-5 rounded-xl border border-slate-200 bg-slate-50/60 p-6 dark:border-white/10 dark:bg-[#161616]">
      <div>
        ...
        <p className="mt-1 text-xs font-semibold text-slate-400">
          Для смены email или пароля укажите текущий пароль.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <label className="space-y-2">
          <span className="text-[11px] font-black uppercase tracking-[0.15em] text-slate-700 dark:text-gray-200">
            Новый пароль
          </span>
          <input
            type="password"
        ...
        <button
          ...
          disabled={saving}
          className="md:col-span-2 rounded-lg bg-brand px-8 py-4 text-xs font-black uppercase tracking-[0.12em] text-white transition hover:scale-[1.01] disabled:opacity-50 dark:text-black"
        >
