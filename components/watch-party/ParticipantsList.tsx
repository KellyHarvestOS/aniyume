    ...
    <div className="bg-black/30 backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-white">Участники</span>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative flex-shrink-0">
                  ...
                  {/* Online dot */}
                  <div className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-[#00E2C4] rounded-full border-2 border-black" />
                </div>

                {/* Name */}
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-1.5">
                    <span className={`text-sm font-medium truncate ${isCurrentUser ? 'text-[#00E2C4]' : 'text-white'}`}>
                      {p.name}
                      {isCurrentUser && ' (вы)'}
                    </span>
                    {isHost && (
