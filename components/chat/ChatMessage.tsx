    ...
    return (
        ...
        >
            <div className={`max-w-[88%] md:max-w-[80%] lg:max-w-[70%] flex flex-col ${isMe ? 'items-end' : 'items-start'}`}>
                ...
                {mediaUrl && (
                    <div className={`mb-1 overflow-hidden rounded-xl md:rounded-2xl border border-gray-200 dark:border-white/10 shadow-sm ${isMe ? 'rounded-br-sm' : 'rounded-bl-sm'}`}>
                        <img
                            src={mediaUrl}
                            alt="media"
                            className="max-w-full max-h-[220px] md:max-h-[300px] object-contain bg-gray-50 dark:bg-white/5"
                        />
                    </div>
                )}
                ...
                {msg.text && (
                    ...
                    ${emojiOnly
                            ? 'bg-transparent !p-0 !border-none !shadow-none text-4xl md:text-6xl my-1 md:my-2 select-none'
                            : `px-3 py-2 md:px-4 md:py-2.5 rounded-xl md:rounded-2xl text-[13px] md:text-[15px] font-medium leading-snug shadow-sm ${isMe
