    ...
    return (
        <div className="relative min-h-dvh lg:h-dvh w-full bg-white dark:bg-[#0a0a0a] lg:bg-[#010606] lg:dark:bg-[#010606] overflow-x-hidden lg:overflow-hidden font-sans flex flex-col lg:block">
            ...
            <div className="absolute inset-0 w-full h-full z-0 hidden lg:block overflow-hidden bg-[#010606]">
                <div className="absolute inset-0 bg-[linear-gradient(45deg,#00F2FE_0%,#168a7f_25%,#0F52BA_50%,#00F2FE_75%,#168a7f_100%)] mix-blend-multiply opacity-[0.35]"></div>
                ...
                <div className="absolute top-[-25%] right-[-15%] w-[65vw] h-[65vw] max-w-[1000px] max-h-[1000px] bg-[conic-gradient(from_0deg,#168a7f,#00F2FE,#020808,#168a7f)] rounded-[40%_60%_70%_30%] filter blur-[120px] opacity-60 pointer-events-none" />
                <div className="absolute bottom-[-25%] right-[5%] w-[55vw] h-[55vw] max-w-[800px] max-h-[800px] bg-[conic-gradient(from_180deg,#a7ffeb,#00F2FE,#0F52BA,#a7ffeb)] rounded-[60%_40%_30%_70%] mix-blend-screen filter blur-[130px] opacity-40 pointer-events-none" />
                        ...
                        <div className="space-y-8">
                            ...
                            <motion.ul variants={containerVariants} initial="hidden" animate="show" className="space-y-6">
                                {[
                                    ...
                                    { icon: <BsFillPeopleFill />, t: "Увеличеный совместный просмотр", d: "До 10 человек одновременно" },
